...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:demoSURGUSvoSedBovTjuv:1.0-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","C:\\Users\\Пользователь\\demo-plugin");
    parameters.put("artifactId","demoSURGUSvoSedBovTjuv");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","C:\\Users\\Пользователь\\demo-plugin\\target\\classes");
    parameters.put("testOutputDirectory","C:\\Users\\Пользователь\\demo-plugin\\target\\test-classes");
